        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('users.update', $user->id) }}">
                    ...
                    <div class="mt-6">
                        <button type="submit"
                            class="ml-4 px-4 py-2 bg-gray-300 text-success-800 rounded-lg hover:bg-gray-400">
                            Update User
                        </button>

                        <a href="{{ route('users.index') }}"
                            class="ml-4 px-4 py-2 bg-gray-300 text-gray-800 rounded-lg hover:bg-gray-400">
                            Cancel
                        </a>
                    </div>
