        ...
        <div class="p-6">
            <form action="{{ route('projects.update', $project->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <x-input label="Title" name="title" placeholder="Enter title" value="{{ $project->title }}" />
                    </div>
                    <div>
                    ...
                    <div>
                        <x-select label="Client" name="client_id" placeholder="Enter client" :options="$clients"
                            :optionKey="'id'" :optionValue="'company_name'" value="{{ $project->client_id }}" />
                    </div>
                    <div>
                        <x-select label="User" name="user_id" placeholder="Enter user" :options="$users" :optionKey="'id'"
                            :optionValue="'full_name'" value="{{ $project->user_id }}" />
                    </div>
                    <div>
